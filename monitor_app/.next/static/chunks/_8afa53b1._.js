...
"use client";
;
/* ─── Helpers ─── */ const randomIp = ()=>"".concat(10 + Math.floor(Math.random() * 240), ".").concat(Math.floor(Math.random() * 256), ".").concat(Math.floor(Math.random() * 256), ".").concat(Math.floor(Math.random() * 256));
const randomPort = ()=>[
        22,
        53,
        80,
...
function Dashboard() {
    ...
    const [threatLevel, setThreatLevel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(12);
    ...
    /* Simulate Data */ const generateFlow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[generateFlow]": ()=>{
            const prob = Math.random();
            const status = prob > 0.85 ? "threat" : prob > 0.7 ? "suspicious" : "safe";
            const connStates = [
                "CON",
                "FIN",
                "INT"
            ...
            return {
                ...
                duration: "".concat((0.01 + Math.random() * 10).toFixed(2), "s"),
                status,
    ...
    const generateActivity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[generateActivity]": (flow)=>{
            if (flow.status === "threat") {
                ...
                return {
                    ...
                    type: "threat",
                    title: attack,
                    detail: "".concat(flow.srcIp, ":").concat(flow.srcPort, " → ").concat(flow.dstIp, ":").concat(flow.dstPort),
                    time: new Date()
                };
            }
            if (flow.status === "suspicious") {
                return {
                    ...
                    detail: "".concat(flow.srcIp, ":").concat(flow.srcPort, " (prob: ").concat(flow.probability, ")"),
                    time: new Date()
                };
            }
            return {
    ...
    }["Dashboard.useCallback[generateActivity]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            /* initial batch */ const initial = Array.from({
                length: 8
            }, {
                "Dashboard.useEffect.initial": ()=>generateFlow()
            }["Dashboard.useEffect.initial"]);
            setFlows(initial);
            setActivity(initial.map(generateActivity));
            setStats({
                totalFlows: initial.length,
                attacksBlocked: initial.filter({
                    "Dashboard.useEffect": (f)=>f.status === "threat"
                }["Dashboard.useEffect"]).length,
                safeFlows: initial.filter({
                    "Dashboard.useEffect": (f)=>f.status === "safe"
                }["Dashboard.useEffect"]).length,
                avgThreatProb: Number((initial.reduce({
                    "Dashboard.useEffect": (s, f)=>s + f.probability
                }["Dashboard.useEffect"], 0) / initial.length).toFixed(3))
            });
            /* continuous stream */ const interval = setInterval({
                "Dashboard.useEffect.interval": ()=>{
                    ...
                    setStats({
                        "Dashboard.useEffect.interval": (prev)=>{
                            ...
                            const avgThreatProb = Number(((prev.avgThreatProb * prev.totalFlows + newFlow.probability) / totalFlows).toFixed(3));
                            return {
                                totalFlows,
                                attacksBlocked,
                                safeFlows,
            ...
            }["Dashboard.useEffect.interval"], 2500);
            /* connectivity check */ const online = setInterval({
                "Dashboard.useEffect.online": async ()=>{
                    try {
            ...
            }["Dashboard.useEffect.online"], 10000);
            return ({
                "Dashboard.useEffect": ()=>{
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: "ML-Powered Network Threat Detection"
                                            }, void 0, false, {
                                                fileName: "[project]/app/page.tsx",
                                                lineNumber: 195,
                                                columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: "ML classification active"
                                    }, void 0, false, {
                                        fileName: "[project]/app/page.tsx",
                                        lineNumber: 225,
                                        columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            (stats.avgThreatProb * 100).toFixed(1),
                                            "%"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/app/page.tsx",
                                        ...
                                        children: activity.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: "The agent will begin capturing traffic shortly."
                                                }, void 0, false, {
                                                    fileName: "[project]/app/page.tsx",
                                                    lineNumber: 267,
                                                    columnNumber: 19
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                ...
                                                                children: stats.totalFlows - stats.safeFlows - stats.attacksBlocked
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/page.tsx",
                                                                lineNumber: 324,
                                                                columnNumber: 19
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                            children: flows.slice(0, 15).map((f)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                    className: "fade-in",
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            style: {
                                                                color: f.probability > 0.7 ? "var(--accent-red)" : f.probability > 0.4 ? "var(--accent-amber)" : "var(--accent-green)"
                                                            },
                                                            children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: "flow-status ".concat(f.status),
                                                                children: f.status === "safe" ? "✅ Safe" : f.status === "threat" ? "🚨 Threat" : "⚠️ Suspicious"
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/page.tsx",
                                                                lineNumber: 385,
                                                                columnNumber: 23
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("footer", {
                        className: "footer",
                        children: [
                            "CyberGuard AI — ML Cyber Attack Prediction System  |  AutoEncoder + SGD Classifier  |  Powered by ",
...
_s(Dashboard, "mQWOrWqqzuuCcnW1mzKaVu/O9e0=");
_c = Dashboard;
var _c;
